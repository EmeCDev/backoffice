...
IF EXISTS (SELECT * FROM sys.servers WHERE name = 'BD3GESTION')
BEGIN
    EXEC sp_dropserver 'BD3GESTION', 'droplogins';
...
EXEC sp_addlinkedserver 
    @server = 'BD3GESTION',  -- Nombre del Linked Server
    @srvproduct = '',
...
EXEC sp_serveroption 'BD3GESTION', 'rpc', 'true';
EXEC sp_serveroption 'BD3GESTION', 'rpc out', 'true';
GO
