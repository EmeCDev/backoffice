...
import './zksenduserrp.css';
import { toast } from 'react-toastify';
import { fetchZkCompanies, fetchZkDevices, sendUserToDevices, sendUserToDevicesAd, sendUserToDevicesRp } from '../../../api/zkManagementApiRequests';
...
const ZkSendUserRp = () => {
    ...
    const [companies, setCompanies] = useState([{ companyId: 0, client: ' Ripley ' }]);
    ...
    useEffect(() => {
        if (serverId !== 0) {
            setCompanies([{ companyId: 0, client: ' Ripley ' }]);
            setCompanyId(0);
            setCompanyDb('');
        }
    }, [serverId])
