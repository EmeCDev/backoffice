...
IF EXISTS (SELECT * FROM sys.servers WHERE name = 'BD1GESTION')
BEGIN
    EXEC sp_dropserver 'BD1GESTION', 'droplogins';
...
EXEC sp_addlinkedserver 
    @server = 'BD1GESTION',  -- Nombre del Linked Server
    @srvproduct = '',
...
EXEC sp_serveroption 'BD1GESTION', 'rpc', 'true';
EXEC sp_serveroption 'BD1GESTION', 'rpc out', 'true';
GO
