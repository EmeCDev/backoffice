...
import './zksenduserad.css';
import { toast } from 'react-toastify';
import { fetchZkCompanies, fetchZkDevices, sendUserToDevicesAd } from '../../../api/zkManagementApiRequests';
...
const ZkSendUserAd = () => {
    ...
    const [companies, setCompanies] = useState([{ companyId: 0, client: 'Arcos Dorados ' }]);
    ...
    useEffect(() => {
        if (serverId !== 0) {
            setCompanies([{ companyId: 0, client: 'Arcos Dorados' }]);
            setCompanyId(0);
            setCompanyDb('');
        }
    }, [serverId])
    ...
    // ==================== OPCIONES ====================
    const serverOptions = [{ value: 2, label: 'Servidor 2' }];
