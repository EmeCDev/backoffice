...
namespace UsersApi.Helpers
{
    public class JwtHelper
    {
        ...
        public JwtHelper(IConfiguration configuration)
        {
            ...
            _secretKey = _configuration["JwtSettings:SecretKey"] ?? string.Empty;
            _issuer = _configuration["JwtSettings:Issuer"] ?? string.Empty;
            _audience = _configuration["JwtSettings:Audience"] ?? string.Empty;
            _expirationMinutes = int.Parse(_configuration["JwtSettings:ExpirationMinutes"] ?? "0");
        }
